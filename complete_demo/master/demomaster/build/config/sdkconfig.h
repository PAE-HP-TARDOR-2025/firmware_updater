...
#define CONFIG_MASTER_NODE_ID 1
#define CONFIG_MASTER_TARGET_NODE_ID 10
#define CONFIG_MASTER_NUM_SLAVES 1
#define CONFIG_MASTER_CAN_BITRATE_KBPS 1000
#define CONFIG_MASTER_TWAI_TX_GPIO 5
#define CONFIG_MASTER_TWAI_RX_GPIO 4
#define CONFIG_MASTER_USE_SPIFFS 1
#define CONFIG_MASTER_SPIFFS_BASE_PATH "/spiffs"
#define CONFIG_MASTER_SPIFFS_PARTITION_LABEL "storage"
#define CONFIG_MASTER_FIRMWARE_PATH "/spiffs/slave_fw.bin"
#define CONFIG_MASTER_MAX_CHUNK_BYTES 512
#define CONFIG_MASTER_UPLOAD_ON_STARTUP 1
#define CONFIG_MASTER_SKIP_IF_CRC_MATCH 1
#define CONFIG_MASTER_FIRMWARE_VERSION 2
